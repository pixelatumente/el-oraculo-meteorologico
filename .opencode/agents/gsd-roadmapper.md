...
Reference full template: `E:/Curso OpenCode/.opencode/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `E:/Curso OpenCode/.opencode/get-shit-done/templates/state.md`.
