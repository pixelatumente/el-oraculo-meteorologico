...
<required_reading>
@E:/Curso OpenCode/.opencode/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@E:/Curso OpenCode/.opencode/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = E:/Curso OpenCode/.opencode
                  → checks E:/Curso OpenCode/.opencode/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = E:/Curso OpenCode/.opencode/get-shit-done
                  → writes to E:/Curso OpenCode/.opencode/get-shit-done/hooks/
...
@E:/Curso OpenCode/.opencode/get-shit-done/references/thinking-models-debug.md
...
- Read @E:/Curso OpenCode/.opencode/get-shit-done/references/common-bug-patterns.md
