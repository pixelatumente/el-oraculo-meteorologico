...
Use template from `E:/Curso OpenCode/.opencode/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `E:/Curso OpenCode/.opencode/get-shit-done/templates/UI-SPEC.md`
