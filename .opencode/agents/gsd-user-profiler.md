...
<reference>
@E:/Curso OpenCode/.opencode/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `E:/Curso OpenCode/.opencode/get-shit-done/references/user-profiling.md` to load:
