...
```markdown
Read E:/Curso OpenCode/.opencode/agents/gsd-ui-researcher.md for instructions.
...
Template: E:/Curso OpenCode/.opencode/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read E:/Curso OpenCode/.opencode/agents/gsd-ui-checker.md for instructions.
