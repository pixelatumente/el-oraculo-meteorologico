...
Read and follow `E:/Curso OpenCode/.opencode/get-shit-done/workflows/transition.md`.
...
- Follow @E:/Curso OpenCode/.opencode/get-shit-done/workflows/diagnose-issues.md
