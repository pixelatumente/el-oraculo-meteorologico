...
INSTALL_JS_GLOBAL="E:/Curso OpenCode/.opencode/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node E:/Curso OpenCode/.opencode/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
