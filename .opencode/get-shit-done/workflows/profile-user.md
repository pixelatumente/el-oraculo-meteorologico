...
Key references:
- @E:/Curso OpenCode/.opencode/get-shit-done/references/ui-brand.md (display patterns)
- @E:/Curso OpenCode/.opencode/agents/gsd-user-profiler.md (profiler agent definition)
- @E:/Curso OpenCode/.opencode/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="E:/Curso OpenCode/.opencode/get-shit-done/USER-PROFILE.md"
...
```bash
cp "E:/Curso OpenCode/.opencode/get-shit-done/USER-PROFILE.md" "E:/Curso OpenCode/.opencode/USER-PROFILE.backup.md"
```
...
✓ Stores profile at E:/Curso OpenCode/.opencode/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `E:/Curso OpenCode/.opencode/get-shit-done/references/user-profiling.md`
...
Reference: @E:/Curso OpenCode/.opencode/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to E:/Curso OpenCode/.opencode/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global AGENTS.md" -- "Add profile to E:/Curso OpenCode/.opencode/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at E:/Curso OpenCode/.opencode/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at E:/Curso OpenCode/.opencode/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to E:/Curso OpenCode/.opencode/AGENTS.md"
...
```bash
BACKUP_PATH="E:/Curso OpenCode/.opencode/USER-PROFILE.backup.md"
```
...
Your profile:    E:/Curso OpenCode/.opencode/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   E:/Curso OpenCode/.opencode/skills/gsd-dev-preferences/SKILL.md
  ✓ AGENTS.md section       ./AGENTS.md
  ✓ Global AGENTS.md        E:/Curso OpenCode/.opencode/AGENTS.md
```
