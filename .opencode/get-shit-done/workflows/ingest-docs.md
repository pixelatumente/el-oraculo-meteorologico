...
```bash
INIT=$(node "E:/Curso OpenCode/.opencode/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "E:/Curso OpenCode/.opencode/get-shit-done/bin/gsd-tools.cjs" commit \
