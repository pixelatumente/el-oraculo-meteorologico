...
<required_reading>
@E:/Curso OpenCode/.opencode/get-shit-done/references/ai-frameworks.md
@E:/Curso OpenCode/.opencode/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read E:/Curso OpenCode/.opencode/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "E:/Curso OpenCode/.opencode/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read E:/Curso OpenCode/.opencode/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read E:/Curso OpenCode/.opencode/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read E:/Curso OpenCode/.opencode/agents/gsd-eval-planner.md for instructions.
