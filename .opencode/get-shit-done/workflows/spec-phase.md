...
```bash
INIT=$(node "E:/Curso OpenCode/.opencode/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @E:/Curso OpenCode/.opencode/get-shit-done/templates/spec.md.
