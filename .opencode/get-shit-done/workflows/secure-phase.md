...
```
Task(
  prompt="Read E:/Curso OpenCode/.opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `E:/Curso OpenCode/.opencode/get-shit-done/templates/SECURITY.md`
