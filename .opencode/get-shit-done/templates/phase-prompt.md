...
<!-- For checkpoint task examples and patterns, see @E:/Curso OpenCode/.opencode/get-shit-done/references/checkpoints.md -->
...
See `E:/Curso OpenCode/.opencode/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `E:/Curso OpenCode/.opencode/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `E:/Curso OpenCode/.opencode/get-shit-done/workflows/verify-phase.md` for verification logic.
